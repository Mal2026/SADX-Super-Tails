...
void CheckSuperMusic_Restart(int playerID) {
	...
	if (CurrentSuperMusic == None || !IsIngame() || !CharObj2Ptrs[playerID] || playertwp[playerID]->counter.b[1] != Characters_Tails ||  EV_MainThread_ptr || CurrentSong == MusicIDs_rndclear)
		return;
